...
FEVD_GDP = squeeze(FEVD_percentiles_narrative(4,:,[1 13 37],:));
FEVD_Prices = squeeze(FEVD_percentiles_narrative(5,:,[1 13 37],:));
FEVD_FFR = squeeze(FEVD_percentiles_narrative(6,:,[1 13 37],:));
FEVD_UNRATE = squeeze(FEVD_percentiles_narrative(7,:,[1 13 37],:));
FEVD_STOCK = squeeze(FEVD_percentiles_narrative(8,:,[1 13 37],:));
...
EX_Tab1 = [FEVD_UF1(:,2) FEVD_UM1(:,2) FEVD_CS1(:,2) FEVD_GDP1(:,2) FEVD_Prices1(:,2) FEVD_FFR1(:,2) FEVD_UNRATE1(:,2) FEVD_STOCK1(:,2)];
EX_Tab1 = round(EX_Tab1,2);
% Table 2: Bounds (fin Uncertainty shock)
EX_Tab2 = [FEVD_UF1(:,[1,3]) FEVD_UM1(:,[1,3]) FEVD_CS1(:,[1,3]) FEVD_GDP1(:,[1,3]) FEVD_Prices1(:,[1,3]) FEVD_FFR1(:,[1,3]) FEVD_UNRATE1(:,[1,3]) FEVD_STOCK1(:,[1,3])];
EX_Tab2 = round(EX_Tab2,2);
% Table 3: Median Macro uncertainty shock
EX_Tab3 = [FEVD_UF2(:,2) FEVD_UM2(:,2) FEVD_CS2(:,2) FEVD_GDP2(:,2) FEVD_Prices2(:,2) FEVD_FFR2(:,2) FEVD_UNRATE2(:,2) FEVD_STOCK2(:,2)];
EX_Tab3 = round(EX_Tab3,2);
% Table 4: Bounds (macroUncertainty shock)
EX_Tab4 = [FEVD_UF2(:,[1,3]) FEVD_UM2(:,[1,3]) FEVD_CS2(:,[1,3]) FEVD_GDP2(:,[1,3]) FEVD_Prices2(:,[1,3]) FEVD_FFR2(:,[1,3]) FEVD_UNRATE2(:,[1,3]) FEVD_STOCK2(:,[1,3])];
EX_Tab4 = round(EX_Tab4,2);
% Table 5: Median CS shock
EX_Tab5 = [FEVD_UF3(:,2) FEVD_UM3(:,2) FEVD_CS3(:,2) FEVD_GDP3(:,2) FEVD_Prices3(:,2) FEVD_FFR3(:,2) FEVD_UNRATE3(:,2) FEVD_STOCK3(:,2)];
EX_Tab5 = round(EX_Tab5,2);
% Table 6: Bounds (CS shock)
EX_Tab6 = [FEVD_UF3(:,[1,3]) FEVD_UM3(:,[1,3]) FEVD_CS3(:,[1,3]) FEVD_GDP3(:,[1,3]) FEVD_Prices3(:,[1,3]) FEVD_FFR3(:,[1,3]) FEVD_UNRATE3(:,[1,3]) FEVD_STOCK3(:,[1,3])];
