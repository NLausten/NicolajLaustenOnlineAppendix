...
Draws_HDs_narrative(:,:,draw) = squeeze(stochasticComponents(4,1:end,:)); % stochasticComponents:
end
% 1.U, 2.EPU, 3.CS, 4.Y, 5.CPI, 6.PRATE, 7.UNRATE, 8.STOXX
...
varNames1 = {'Financial Uncertainty','EPU','Credit Spread','Industrial Production'};
shockNames1 = {'Financial Uncertainty','EPU','Credit Spread','Industrial Production'};
...
%fname = strcat('results/HD_EU3Aunrate.eps');
%print('-depsc', f, fname);